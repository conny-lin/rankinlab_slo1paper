...
% chor 
[~,pMWTpass,pMWTfailed] = chormaster5('ShaneSpark',pMWT); % chor
pMWTinput = pMWT;
pMWT = pMWTpass;
...
%% HAB CURVE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% stats %-----------------------------------------------------------------
Stats_HabCurveRMANOVA(DataTrv,MWTDB,pSave);
%--------------------------------------------------------------------------
...
for msri = 1:numel(msrlist)
    ...
    D = innerjoin(D,D1);
    D = innerjoin(D,Df);
    D.(component) = D.HabLevel./D.Initial;
