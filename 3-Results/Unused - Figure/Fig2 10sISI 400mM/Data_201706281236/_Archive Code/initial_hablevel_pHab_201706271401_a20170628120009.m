...
Data.expname = exp;
% anova
TAL = Stats_Output_ANOVA_GraphTable(Data,MWTSet,msrlist,component,pSave);
% within group percent initial
TAL = Stats_Output_ttest_pctCtrl(msrlist,Data,ctrl,component,pSave,1);
...
% within group percent initial
MWTSet = Stats_Output_ttest_pctCtrl(msrlist,Data,ctrl,component,pSave,1);
return
